...
public class GetStationsResponse {
     ...
     * ResponseCode : 200
     * ResponseMsg : 操作成功
     * PageInfo : {"PageFlag":"StationName","PageNumber":1,"PageSize":10,"TotalNumber":1}
     * StationList : [{"StationUUID":"6159529a-6bc3-4c73-84d1-e59f6f60ece6","DeviceUUID":"6159529a-6bc3-4c73-84d1-e59f6f60ece6","ProjectUUID":"1febf7af-2159-6218-16b2-91d14c8dd186","StationName":"监测点名称","StationType":"2","StationAddress":"北京","StationLongitude":"116.480998473333","StationLatitude":"39.872120703333","StationAltitude":"57.613500000000","StationModel":"设备型号","StationSerialNumber":"设备序列号","StationBatchNumber":"生产批号","StationProductDate":"2020-01-01 00:00:00","StationManufacturer":"BDJC","StationMAC":"00:00:00:00:00","StationIMSI":"IMSI","StationICCID":"ICCID","StationGNSSInfo":"GNSSInfo","StationPrincipalName":"","StationPrincipalMobile":"","StationStatus":"20","StationStatusDetail":"监测点超过900秒无上报","StationStartTime":"2020-02-23 01:00:00","StationEndTime":"2030-01-01 00:00:00","StationCreateTime":"2020-02-23 01:00:00","StationModifyTime":"2021-03-24 10:02:53","StationLastTime":"2021-02-23 18:02:33","ProjectName":"系统测试工程","StationConditionList":[]}]
     */
    ...
    public static class StationListBean {
        /**
         * StationUUID : 6159529a-6bc3-4c73-84d1-e59f6f60ece6
         * DeviceUUID : 6159529a-6bc3-4c73-84d1-e59f6f60ece6
         ...
         * StationProductDate : 2020-01-01 00:00:00
         * StationManufacturer : BDJC
         * StationMAC : 00:00:00:00:00
         * StationIMSI : IMSI
         * StationICCID : ICCID
         * StationGNSSInfo : GNSSInfo
         * StationPrincipalName :
         * StationPrincipalMobile :
         * StationStatus : 20
         * StationStatusDetail : 监测点超过900秒无上报
         * StationStartTime : 2020-02-23 01:00:00
         * StationEndTime : 2030-01-01 00:00:00
         * StationCreateTime : 2020-02-23 01:00:00
         * StationModifyTime : 2021-03-24 10:02:53
         * StationLastTime : 2021-02-23 18:02:33
         * ProjectName : 系统测试工程
        ...
        private String StationPrincipalName;
        private String StationPrincipalMobile;
        ...
        public String getStationPrincipalName() {
            return StationPrincipalName;
        }

        public void setStationPrincipalName(String StationPrincipalName) {
            this.StationPrincipalName = StationPrincipalName;
        }

        public String getStationPrincipalMobile() {
            return StationPrincipalMobile;
        }

        public void setStationPrincipalMobile(String StationPrincipalMobile) {
            this.StationPrincipalMobile = StationPrincipalMobile;
        }
